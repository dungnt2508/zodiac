...
clientInstance = AstrologyAPIClient(638604, 'fad3fb54b614135f4c9ce3a112ea6212a63f3640')
...
# call horoscope apis
# responseData = clientInstance.call(resource, data['date'], data['month'], data['year'], data['hour'], data['minute'], data['latitude'], data['longitude'], data['timezone'])

responseData = clientInstance.dailyHoroCall(
                                    resource
                                    , zodiacName
                                    , data['timezone']
                                    )
