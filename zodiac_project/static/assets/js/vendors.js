                                    ...
                                    <div class="vendor-content-wrap">
                                        ...
                                        <div class="vendor-info mb-30">
                                            <ul class="contact-infor text-muted">
                                                <li><img src="/static/assets/imgs/theme/icons/icon-location.svg" alt="" /><strong>Địa chỉ: </strong> <span>${vendor.address}, ${vendor.city} ${vendor.post_code} ${vendor.country}</span></li>
                                                <li><img src="/static/assets/imgs/theme/icons/icon-contact.svg" alt="" /><strong>Liên hệ:</strong><span>${vendor.mobile_number}</span></li>
                                            </ul>
                                        </div>
                                        <a href="/vendor-details/${vendor.slug}" class="btn btn-xs">Ghé thăm cửa hàng <i class="fi-rs-arrow-small-right"></i></a>
                                    </div>
                                </div>
                            </div>
                            <!--end vendor card-->`
