            ...
            success: function (response) {
                ...
                setTimeout(() => {
                    ...
                    if (response.products_size > 0) {
                        productNum.innerHTML = `<p>Chúng tôi đã tìm thấy <strong class="text-brand">${response.products_size}</strong> sản phẩm dành cho bạn!</p>`
                    }
                    else {
                                    ...
                                    <div class="product-cart-wrap mb-30">
                                        ...
                                        <div class="product-content-wrap">
                                            ...
                                            <div class="product-card-bottom">
                                                ...
                                                <div class="add-cart">
                                                    <a class="add" href="/product-details/${product.PRDSlug}"><i class="fi-rs-eye mr-5"></i>Xem </a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    if (maxSize) {
                        ...
                        emptyBox.innerHTML = `<strong class="current-price text-brand">- - -</strong>`
                    }
